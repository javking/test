...
class fm_photosvoteModuleSite extends WeModuleSite {
    ...
    public function __mobile($f_name) {
        ...
        //WeUtility::logging("Mobile",$_COOKIE);
     ...
     * */
    public function fm_qrcode($value = 'http://www.012wz.com', $filename = '', $pathname = '', $logo, $scqrcode = array('errorCorrectionLevel' => 'H', 'matrixPointSize' => '4', 'margin' => '5')) {
        global $_W;
        $uniacid = !empty($_W['uniacid']) ? $_W['uniacid'] : $_W['acid'];
