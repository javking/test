    ...
    public function doMobileResearch() {
        ...
        if (checksubmit('submit')) {
            ...
            if (!empty($datas) && !empty($activity['noticeemail'])) {
                ...
                if (!empty($update['reside'])) {
                    switch ($update['reside']) {
                        case "光谷德国风情街校区":
                            ihttp_email('tina@idealangel.cn', $activity['title'] . '的预约提醒', $body);
                            break;
                        case "汉口菱角湖万达校区":
                            ihttp_email('windy@idealangel.cn', $activity['title'] . '的预约提醒', $body);
                            break;
                        case "光谷时代广场校区":
                            ihttp_email('mary@idealangel.cn', $activity['title'] . '的预约提醒', $body);
                            break;
                        case "青山奥山世纪城校区":
                            ihttp_email('judy@idealangel.cn', $activity['title'] . '的预约提醒', $body);
                            break;
                        default :
